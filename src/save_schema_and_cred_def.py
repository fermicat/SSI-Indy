...
async def write_schema_and_cred_def():
    try:
        ...
        """
        A. point the SDK at some genesis transactions that tell the SDK how to contact the ledger on the network;
        B. create a wallet so the SDK can store DIDs and the key materia
        C. create a trust anchor identity (has privileges to create schemas and credential definitions.)
        """
        # 1.
        ...
        """
        create and define a schema.

        sample schema in JSON-like form
        """
        # 9.
