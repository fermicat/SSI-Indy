...
async def proof_negotiation():
    try:
        ...
        """
        create another to identity hold credentials once they're issued.
        """
         # 12.
        ...
        # 13.
        # A link secret is a special piece of data that's inserted into a credential, in blinded form, on issuance; 
        # it is used to prove that the credential in question belongs to a particular holder and not to someone else. 
        ...
        First, the issuer offers a credential.
        Next, the holder requests the credential, supplying the blinded link secret that will bind it to them.
        Finally, the issuer generates the credential and gives it to the holder.
        """
        # 14.
