...
async def proof_negotiation():
    try:
        ...
        """
        Proof negotiation  begins: 
        A. Verifier (also called a relying party) requests proof.
        B. a holder of credentials must scan their identity wallet to find out which credentials could be used to satisfy the request.
        ...
        """
        Holder becomes a prover by generating and presenting a proof. 
        This is done by building some JSON that selects the credentials
        """
        # 20.
        ...
        """
        Verifier check to make sure the proof that's presented satisfies their criteria
        """
        # 21.
