...
async def rotate_key_on_the_ledger():
	try:
        ...
        #The replace_keys_start method tells the wallet that an update is pending, 
		# and that it should track both the new and old keypairs for the identity. 
        ...
        # The replace_keys_apply resolves the pending status so the new value becomes canonical in the local wallet 
        # (after it has already become canonical on the ledger).
